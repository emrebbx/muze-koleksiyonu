...
function v80KartGorseliniHazirla(kartBilgisi, tamamlandi) {
  ...
  const dene = () => {
    ...
    const zamanAsimi = setTimeout(() => {
      ...
      kontrol.src = "";
      if (deneme < 2) dene();
      else bitir(v80YedekKartGorseli(kartBilgisi));
    }, 3500);
    ...
    const ayirici = String(kartBilgisi.dosya).includes("?") ? "&" : "?";
    kontrol.src = deneme === 1
      ? kartBilgisi.dosya
      : `${kartBilgisi.dosya}${ayirici}v80yeniden=${Date.now()}`;
  };
