...
function cekilenKartiBuyukGoster(
  ...
  /*
    Kart hiçbir zaman boş/bekleyen bir ekran olarak açılmaz. Önce adı ve
    türü bulunan yerel yedek yüz gösterilir; gerçek PNG hazır olduğunda
    aynı img üzerinde değiştirilir. Görsel ağı oyun akışını kilitleyemez.
  */
  kart.src =
    v80YedekKartGorseli(kartBilgisi);


  const gercekKartGorseli =
    new Image();


  gercekKartGorseli.onload =
    () => {
  ...
  gercekKartGorseli.onerror =
    () => {

      console.warn(
        "Kartın gerçek görseli yüklenemedi; yedek yüz kullanılıyor:",
        kartBilgisi.dosya
      );
    };


  gercekKartGorseli.src =
    kartBilgisi.dosya;
